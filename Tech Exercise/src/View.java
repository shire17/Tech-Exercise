...
public class View extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      out.println(docType +
		            ...
		            "<body>\n" + //
		            "<header>" +
		            "<div class=\"dropdown\" style=\"display:inline-block; float: left;\"><button class=\"dropdown-btn\">Sort By</button>" +
		            "<div class=\"dropdown-content\"><a href=\"#\">Name</a>" +
	      			"<a href=\"#\">Description</a>" +
		            "<a href=\"#\">Due Date</a></div></div><br>" +
	      ...
	      try {
	         ...
	         if (rs.next() == false) {
	        	 ...
	        	 do {
		            ...
		            out.print("<b>Due Date: </b>" + dueDate + "<br><br>");
	        	 } while (rs.next());
	         }
	         out.println("</div>");
	         out.println("<div>");
